...
import 'notification_create_service.dart';
                    ...
                    children: [
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration:
                              textfieldDecoration('Notification Description'),
                          validator: (value) {
                        ...
                        child: Row(
                          children: [
                            Flexible(
                              ...
                              child: TextFormField(
                                decoration:
                                    textfieldDecoration('Malfunction Date'),
                                key: Key(
                        ...
                        child: Row(
                          children: [
                            Flexible(
                              ...
                              child: TextFormField(
                                decoration:
                                    textfieldDecoration('Malfunction Time'),
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: textfieldDecoration('Notification Type'),
                        ),
                      ),
                      Container(
                        padding: ktextfieldPadding,
                        child: TextFormField(
                          ...
                          decoration: textfieldDecoration('Planning Plant'),
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: textfieldDecoration('Planner Group'),
                          ...
                          children: [
                            Flexible(
                              ...
                              child: TextFormField(
                                ...
                                decoration:
                                    textfieldDecoration('Required Start Date'),
                                key: Key(
                                    reqstartDate.toString().substring(0, 10)),
                                initialValue:
                                    reqstartDate.toString().substring(0, 10),
                              ),
                            ),
                          ...
                          children: [
                            Flexible(
                              ...
                              child: TextFormField(
                                ...
                                decoration:
                                    textfieldDecoration('Required End Date'),
                                key:
                                    Key(reqendDate.toString().substring(0, 10)),
                                initialValue:
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            if (_formKey.currentState!.validate()) {
                              ...
                              NotifCreateService create = NotifCreateService();
