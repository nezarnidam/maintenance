...
class NotificationUpdateService {
  Future<int> getData(Map<String, String> mp) async {
    var url = Uri.http('192.168.18.8:3000', '/mntNotifUpdate');
    http.Response res = await http.post(
      ...
      body: jsonEncode(<String, String>{
        ...
        "reqend_time": mp['reqend_time'].toString(),
        "reqstart_date": mp['reqstart_date'].toString(),
        "reqstart_time": mp['reqstart_time'].toString(),
      }),
    );
