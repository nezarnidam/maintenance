...
class TechCompletedWorkorder extends StatefulWidget {
  final view;
  TechCompletedWorkorder(this.view);
  @override
  _TechCompletedWorkorderState createState() => _TechCompletedWorkorderState();
}

class _TechCompletedWorkorderState extends State<TechCompletedWorkorder> {
  String prevView = '';
  bool loading = false;
